...
# Already setup in the parent environment from container.
# ANDROID_STUDIO="$HOME/Apps/android-studio"
# ANDROID_HOME="$HOME/Android/Sdk"
# ANDROID_SDK_ROOT="$ANDROID_HOME"
# export PATH="$PATH:$ANDROID_STUDIO/bin:$ANDROID_HOME/platform-tools"
